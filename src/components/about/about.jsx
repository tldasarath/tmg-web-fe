        ...
        <div className="relative z-10 flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="text-gray-600 text-[0.938rem] md:text-lg font-normal leading-relaxed">
              ...
              <p>
                At TMG Global, we combine local expertise, global perspective,
                and customer-first service — ensuring fast, compliant, and
                reliable business solutions tailored to your needs.
              </p>
            </div>
          </div>
