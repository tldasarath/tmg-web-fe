    ...
    const mockPosts = [
      {
        id: "1",
        mediaUrl:
          "/assets/images/social/insta_post1.jpg",
        caption:
          "Certified translators you can trust!",
        timestamp: "2 hours ago",
        postUrl: "https://www.instagram.com/p/DPnhR92Ac3q/?igsh=Z3R0d2V6dDM2ajF4",
      },
      {
        id: "2",
        mediaUrl:
          "/assets/images/social/insta_post2.jpg",
        caption: "Start your UAE business with IFZA — the fastest-growing free zone in Dubai!",
        timestamp: "1 day ago",
        postUrl: "https://www.instagram.com/p/DPf32iigdge/?igsh=eWJ4MDNiZnRrdmc3",
      },
      {
        id: "3",
        mediaUrl:
          "/assets/images/social/insta_post3.jpg",
        caption: "Start your own Event Management Company in Dubai with expert guidance from TMG Global.",
        timestamp: "2 days ago",
        postUrl: "https://www.instagram.com/p/DPdad30gdH2/?igsh=MTB0NDM0ZzJrZXlnZg==",
      },
      {
        id: "4",
        mediaUrl:
          "/assets/images/social/insta_post4.jpg",
        caption: " Simplify Your Legal Matters Online with TMG Global! ✨",
        timestamp: "3 days ago",
        postUrl: "https://www.instagram.com/p/DPS7fckgUxF/?igsh=MTg5d2cwdWNpeGwzZg==",
      },
      {
        id: "5",
        mediaUrl:
          "/assets/images/social/insta_post5.jpg",
        caption: "Celebrating the legacy of peace, truth, and harmony. ✨ Happy Gandhi Jayanti!",
        timestamp: "5 hours ago",
        postUrl: "https://www.instagram.com/p/DPS5ooFgbCb/?igsh=NXc3OGVqZmRuNHAy",
      },
      {
        id: "6",
        mediaUrl:
          "/assets/images/social/insta_post6.jpg",
        caption: "Empowering your business with AI-powered solutions for a future-ready tomorrow.",
        timestamp: "5 hours ago",
        postUrl: "https://www.instagram.com/p/DM9pmedtM9G/?igsh=YmxnbXVkNGowZ290",
      },
    ];
      ...
      <div className="max-w-7xl mx-auto pt-16 pb-16 md:pb-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
          <div className="opacity-0 animate-fade-in">
            <h2 className="text-5xl md:text-6xl font-bold bg-[linear-gradient(180deg,rgba(152,32,68,1)_0%,rgba(100,14,41,1)_100%)] bg-center bg-clip-text text-transparent mb-2">
              Social Media
            </h2>
